    ...
    <>
      <section className="bg-afro-green pt-12 pb-10 text-afro-cream sm:pt-16">
        <div className="container-x grid gap-10 md:grid-cols-[1.2fr_1fr] md:items-center">
          <div>
            <p className="eyebrow text-afro-orange-soft">Notre histoire</p>
            <h1 className="heading-display mt-3 text-4xl sm:text-5xl lg:text-6xl">
              Afro dans l&apos;âme,
              <br />
              <span className="text-afro-orange">gastro</span> dans l&apos;assiette.
            </h1>
            <p className="mt-5 max-w-xl text-afro-cream/85">
      ...
      <section className="bg-afro-cream-soft py-16">
        <div className="container-x rounded-xl bg-white p-8 shadow-soft sm:p-12">
          <h2 className="heading-display text-3xl text-afro-green sm:text-4xl">
            Pourquoi 24h à l&apos;avance&nbsp;?
          </h2>
          <p className="mt-4 max-w-3xl text-afro-black/75">
...
function Pillar({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="rounded-lg bg-white p-6 shadow-soft">
      <h3 className="font-display text-xl font-bold text-afro-orange">{title}</h3>
      <p className="mt-3 text-afro-black/75">{children}</p>
    </div>
  );
}
