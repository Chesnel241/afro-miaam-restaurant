                ...
                <OrderProvider>
                  ...
                  <CartProvider>
                    {/* Skip-to-content link — visible only on keyboard focus.
                        Lets screen-reader and keyboard users jump past the
                        header chrome straight into the page body. WCAG 2.4.1. */}
                    <a
                      href="#main-content"
                      className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[200] focus:rounded-md focus:bg-primary focus:px-4 focus:py-2 focus:text-cream focus:shadow-lg"
                    >
                      Aller au contenu principal
                    </a>
                    <Header />
